...
function deleteProduct(id) 
  ...
  setProducts(newProducts);
    ...
    const searcedProduct = products.filter(
      (items) => (

        items.title.toLowerCase().startsWith(search.toLowerCase())
  ...
  return (
    <>
      ...
      } type="search" placeholder="Search by Websites" /> 

      <h1> Marketly </h1>

      <div className="products-container">
        {searcedProduct.map((item) => (
